...
<div class="contact">
    <form method="post" action="php/demandecontact.php">
        ...
        <label>Nom</label> <input class="formulaire" type="text" name="nom" required><br><br>
        <label>Prenom</label> <input class="formulaire" type="text" name="prenom" required><br><br>
        <label>Email</label> <input class="formulaire" type="email" name="email" required><br><br>
        ...
        <br><br>
        <label>Sujet</label><input class="formulaire" type="text" name="sujet" required><br><br>
        <label>Contenu</label><input class="formulaire" type="text" name="contenu" required>   <br><br>
