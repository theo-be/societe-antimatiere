...
<div class="contact">
    <form method="post" action="php/demandecontact.php">
        ...
        <label>Nom</label> <input type="text" placeholder="Entrez Nom" name="nom" ' . remplir_formualire("nom") . ' required><br><br>
        <label>Prenom</label> <input type="text" placeholder="Entrez Prenom" name="prenom" ' . remplir_formualire("prenom") . ' required><br><br>
        <label>Email</label> <input type="email" placeholder="monmail@monsite.org" name="email" ' . remplir_formualire("email") . ' required><br><br>
        ...
        <br><br>
        <label>Sujet:</label><input type="text" placeholder="Entrez le sujet de votre mail" name="sujet" ' . remplir_formualire("sujet") . ' required><br><br>
        <label>Contenu:</label><input type="text" placeholder="Tapez ici votre mail" name="contenu" ' . remplir_formualire("contenu") . ' required>   <br><br>
';
        ?>
